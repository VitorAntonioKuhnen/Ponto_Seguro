...
from home.models import HistRegistro, HoraExtra, Justificativa, Feriado
...
def get_api_feriados():
  resposta = requests.get(f'https://api.invertexto.com/v1/holidays/2023?token={config("TOKEN")}&state={config("ESTADOUF")}')
